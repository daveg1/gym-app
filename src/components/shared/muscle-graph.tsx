...
export function MuscleGraph(props: Props) {
  if (props.view === "back")
    return <BackView onMuscleSelect={props.onMuscleSelect} />;

  return <FrontView onMuscleSelect={props.onMuscleSelect} />;
}

function FrontView(props: Pick<Props, "onMuscleSelect">) {
  const [elementRef] = useTouchHighlight();
...
function BackView(props: Pick<Props, "onMuscleSelect">) {
  const [elementRef] = useTouchHighlight();
  ...
  return (
    ...
    >
      <g
        id="traps"
        onTouchEnd={() => props.onMuscleSelect("Traps")}
        className="text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
      >
        <path
      ...
      <g
        id="hamstrings"
        onTouchEnd={() => props.onMuscleSelect("Hamstrings")}
        className="text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
      >
        <path
      ...
      <g
        id="glutes"
        onTouchEnd={() => props.onMuscleSelect("Glutes")}
        className="text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
      >
        <path
      ...
      <g
        id="triceps"
        onTouchEnd={() => props.onMuscleSelect("Triceps")}
        className="text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
      >
        <path
