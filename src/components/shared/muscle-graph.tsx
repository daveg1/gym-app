...
/**
 * Disclaimer: totally not ripped from https://musclewiki.com/ lol
 */
export function MuscleGraph(props: Props) {
  return (
    <svg
      ...
      className="object-fit animate-fade-in w-full px-4"
    >
      <g
        id="calves"
        onClick={() => props.onMuscleClick("Calves")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="quads"
        onClick={() => props.onMuscleClick("Quads")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="abdominals"
        onClick={() => props.onMuscleClick("Abs")}
        className="bodymap text-gray-300 active:text-red-400"
        fill="mw-red"
      >
        <path
      ...
      <g
        id="obliques"
        onClick={() => props.onMuscleClick("Obliques")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="hands"
        onClick={() => props.onMuscleClick("Hands")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="forearms"
        onClick={() => props.onMuscleClick("Forearms")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="biceps"
        onClick={() => props.onMuscleClick("Biceps")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="front-shoulders"
        onClick={() => props.onMuscleClick("Shoulders")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="chest"
        onClick={() => props.onMuscleClick("Chest")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
      ...
      <g
        id="traps"
        onClick={() => props.onMuscleClick("Traps")}
        className="bodymap text-gray-300 active:text-red-400"
      >
        <path
